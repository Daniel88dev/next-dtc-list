      ...
      <div className="min-h-[90%] flex flex-col items-center justify-center p-4">
        <main className="max-w-4xl w-full rounded-lg shadow-xl p-8 space-y-8">
          <div className="max-w-4xl mx-auto p-6">
            ...
            <p className="mb-4">
              Welcome to our DTC Code Lookup service. By using our website, you
            ...
            <p className="mb-4">
              You may create an account using Clerk authentication. Your
              personal information is stored securely and managed according to
              our{" "}
            ...
            <p className="mb-4">
              ...
              Protection Regulation (GDPR). Data retrieved from our database
              (NeonDB) and ChatGPT API is used solely for providing search
              results.
            </p>
            ...
            <p className="mb-4">
              Our service provides information based on stored data and
              AI-generated content. We do not guarantee the accuracy or
            ...
            <p className="mb-4">
              Users must ensure their queries and interactions comply with
              applicable laws. Misuse of the service, including automated
              scraping or malicious activities, is strictly prohibited.
            </p>
